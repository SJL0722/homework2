...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        ...
        <div class="row clearfix channel-list">
            <div class="col-xs-12">
                <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 channel-list-item">
