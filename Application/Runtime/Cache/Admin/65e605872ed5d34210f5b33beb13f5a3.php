  ...
  <div class="container-fluid">
    ...
    <?php if(($_SESSION['type']) == "tomin"): ?><li>
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <p class="pull-right" style="margin-top: 20px;"><!--<button class="btn btn-danger" type="button" id="deleteA">批量删除</button>--></p>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <form action="/aiyingshi/admin/User/delete_all" method="get" id="list">
                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td><?php echo ($k); ?></td>
                    <td>
                        <img class="img-rounded img-responsive" src="/aiyingshi/Public/<?php echo ($item["img"]); ?>" width="64px"/>
                    </td>
                    <td><?php echo ($item["username"]); ?></td>
                    <td><a class="btn btn-danger" href="/aiyingshi/Admin/User/delete?id=<?php echo ($item["id"]); ?>">删除</a></td>
