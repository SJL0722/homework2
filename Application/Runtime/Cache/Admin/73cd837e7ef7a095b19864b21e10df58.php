...
<body>
    ...
    <?php if(($_SESSION['type']) == "tomin"): ?><li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <h2 class="sub-header">影片管理:添加影片</h2>
                <form class="form-horizontal" action="/aiyingshi/admin/movie/add_process" method="post" enctype="multipart/form-data" autocomplete="off">

                    <!-- 文本框-->
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="name">题目</label>
                        <div class="col-md-8">
                            <input id="uid" name="uid" type="hidden" value="0" required />
                            <input id="ispass" name="ispass" type="hidden" value="1" required />
