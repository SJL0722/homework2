    ...
    <?php if(($_SESSION['type']) == "tomin"): ?><li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <p class="pull-right" style="margin-top: 20px;">
                    <a class="btn btn-success" href="/aiyingshi/Admin/News/add?id=<?php echo ($item["id"]); ?>">添加</a>
                </p>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <form id="list">
                                <?php if(is_array($mlist)): $k = 0; $__LIST__ = $mlist;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($k); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="/aiyingshi/Admin/News/change?id=<?php echo ($item["id"]); ?>">修改</a>
                                            <a class="btn btn-danger" href="/aiyingshi/Admin/News/delete?id=<?php echo ($item["id"]); ?>">删除</a>
                                        </td>
